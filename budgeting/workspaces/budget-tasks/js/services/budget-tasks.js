...
(function (angular) {
    ...
    function budgetTasksSvc( $q, $http,$resource) {
        ...
        function markTaskAsComplete() {
            ...
            url = '/api/budgeting/common/taskuserstatus/:taskID/status/complete';    
            defaults = {};   
            actions = {
                putData: {
                    method: 'PUT',
        ...
        function markTaskAsCompleteForEditable() {
            var url, actions, defaults;
            url = '/api/budgeting/common/task/:taskID/status/complete';    
            defaults = {};   
            actions = {
                putData: {
                    method: 'PUT',
       ...
       function getCommentByTaskCommentID() {
        ...
        svc.markTaskAsCompleteForEditable=markTaskAsCompleteForEditable().putData;
