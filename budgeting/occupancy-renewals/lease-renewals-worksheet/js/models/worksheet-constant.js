...
(function (angular) {
    ...
    function factory(
        ...
        model.templateConfig.budgetedMvExpiringNavigation = "occupancy-renewals/lease-renewals-worksheet/templates/bdgtd-moveins-exp-navigation.html";
    ...
    angular
        .module("budgeting")
        .factory("leaseWorksheetConstantModel", [
            'bmGridConstantModel',
