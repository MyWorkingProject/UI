(function(angular) {
    ...
    function factory(
        $filter,
        serviceGroupConstant, //serviceGroupConstant,
        serviceGroupContent, //serviceGroupContent,
        preferencesSVC) {
        var model = {},
            rowConfig,
            prefName,
        ...
        model.reset = function() {
            ...
            prefName = 'occupancyVacanyServiceGroupSummary';
            rowOptions = {
                title: serviceGroupContent.gridRowOptionText,
                name: 'rowOptions',
                options: [{
                    key: 'show_reference_row',
                    isVisible: false,
                    title: serviceGroupContent.gridShowReferenceRowText,
                    value: false
                }, {
                    key: 'show_calculation_row',
                    title: serviceGroupContent.gridShowCalculatedRowText,
                    isVisible: false,
                    value: false
                }],
                itemType: 'checkbox',
            ...
            sizeOptions = {
                ...
                selected: '',
                options: [{
                        title: serviceGroupContent.gridShowSmallSizeText,
                        value: '',
                        isVisible: true
                    },
                    {
                        title: serviceGroupContent.gridShowLargeSizeTextText,
                        value: 'large',
                        isVisible: true
                    }
                ],
            ...
            gridColumns = {
                title: serviceGroupContent.gridShowColumnOptionTextText,
                name: 'gridColumns',
                options: [],
                itemType: 'checkbox',
                hasDivider: false
