(function(angular) {
    ...
    function factory(
        ...
        model.reset = function() {
            rowConfig = lrSummaryConstant.getRowConfigs();
            prefName = 'accountByAccount_edit';
            rowOptions = {
                title: lrSummaryContent.gridRowOptionText,
                name: 'rowOptions',
                options: [{
                    key: 'show_reference_row',
                    isVisible: false,
                    title: lrSummaryContent.gridShowReferenceRowText,
                    value: false
                }, {
                    key: 'show_calculation_row',
                    title: lrSummaryContent.gridShowCalculatedRowText,
                    isVisible: true,
                    value: false
                }],
                itemType: 'checkbox',
            ...
            sizeOptions = {
                ...
                selected: '',
                options: [{
                        title: lrSummaryContent.gridShowSmallSizeText,
                        value: '',
                        isVisible: true
                    },
                    {
                        title: lrSummaryContent.gridShowLargeSizeTextText,
                        value: 'large',
                        isVisible: true
                    }
                ],
            ...
            gridColumns = {
                title: lrSummaryContent.gridShowColumnOptionTextText,
                name: 'gridColumns',
                options: [],
                itemType: 'checkbox',
                hasDivider: false
    ...
    angular
        .module("budgeting")
        .factory("leaseGridOptionConfigModel", [
            '$filter',
