(function(angular) {
    ...
    function factory(
        $filter,
        worksheetConstant, //worksheetConstant,
        ...
        model.reset = function() {
            ...
            prefName = 'occpancyVacanyWorksheet';
            rowOptions = {
                title: worksheetContent.gridRowOptionText,
                name: 'rowOptions',
                options: [{
                    key: 'show_reference_row',
                    isVisible: true,
                    title: worksheetContent.gridShowReferenceRowText,
                    value: true
                }, {
                    key: 'show_calculation_row',
                    title: worksheetContent.gridShowCalculatedRowText,
                    isVisible: false,
                    value: false
                }],
                itemType: 'checkbox',
            ...
            sizeOptions = {
                ...
                selected: '',
                options: [{
                        title: worksheetContent.gridShowSmallSizeText,
                        value: '',
                        isVisible: true
                    },
                    {
                        title: worksheetContent.gridShowLargeSizeTextText,
                        value: 'large',
                        isVisible: true
                    }
                ],
            ...
            gridColumns = {
                title: worksheetContent.gridShowColumnOptionTextText,
                name: 'gridColumns',
                options: [],
                itemType: 'checkbox',
                hasDivider: false
    ...
    angular
        .module("budgeting")
        .factory("worksheetGridOptionConfigModel", [
            '$filter',
