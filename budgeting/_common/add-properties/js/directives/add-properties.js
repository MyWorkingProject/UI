...
(function(angular) {
    ...
    function glAccountFind($timeout, $document, findGlAccountSvc, langTranslate, $q, $http, eventStream) {
        function link(scope, elem, attr) {
            ...
            dir.init = function() {
                dir.glList = [];
                //dir.glSrchSvc = angular.extend(findGlAccountSvc);
                scope.dir = dir;
                //dir.getGlAccount("");
    ...
    angular
        .module("budgeting")
        .directive('glAccountFind', ['$timeout', '$document', 'findGlAccountSvc', 'appLangTranslate', '$q', '$http', 'eventStream', glAccountFind]);
})(angular);