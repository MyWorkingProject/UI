...
(function (angular) {
    ...
    function factory(marketRentSettingModel) {
        return function (model, periodModel) {
            ...
            defaultEditable = [{
                ...
                key: "programUnitCount",
                templateUrl: "rentalincome/marketrent/templates/mktrentunit-editable.html",
    ...
    angular
        .module("budgeting")
        .factory("MarketRentUnitTypeProgramModelConfig", ["MarketRentSettingModel", factory]);
})(angular);
