...
(function (angular) {
    ...
    function rpBarChart1(baseDir) {
        var template = "<div class='rp-bar-chart2' />";
    ...
    angular
        .module("rpChart")
        .directive("rpBarChart2", ["rpBaseChartDir", rpBarChart1]);
})(angular);
...
(function (angular) {
    ...
    function rpLineChart2(baseDir) {
        var template = "<div class='rp-line-chart2' />";
    ...
    angular
        .module("rpChart")
        .directive("rpLineChart2", ["rpBaseChartDir", rpLineChart2]);
})(angular);
