...
i.hour(e),i.minute(f),i.second(g),this.setStartDate(i),this.singleDatePicker?this.endDate=this.startDate.clone():this.endDate&&this.endDate.format("YYYY-MM-DD")==i.format("YYYY-MM-DD")&&this.endDate.isBefore(i)&&this.setEndDate(i.clone())}else if(this.endDate){var j=this.endDate.clone();j.hour(e),j.minute(f),j.second(g),this.setEndDate(j)}this.updateCalendars(),this.updateFormInputs(),this.renderTimePicker("left"),this.renderTimePicker("right")},formInputsChanged:function(c){var d=b(c.target).closest(".calendar").hasClass("right"),e=a(this.container.find('input[name="daterangepicker_start"]').val(),this.locale.format),f=a(this.container.find('input[name="daterangepicker_end"]').val(),this.locale.format);e.isValid()&&f.isValid()&&(d&&f.isBefore(e)&&(e=f.clone()),this.setStartDate(e),this.setEndDate(f),d?this.container.find('input[name="daterangepicker_start"]').val(this.startDate.format(this.locale.format)):this.container.find('input[name="daterangepicker_end"]').val(this.endDate.format(this.locale.format))),this.updateView()},formInputsFocused:function(a){this.container.find('input[name="daterangepicker_start"], input[name="daterangepicker_end"]').removeClass("active"),b(a.target).addClass("active");var c=b(a.target).closest(".calendar").hasClass("right");c&&(this.endDate=null,this.setStartDate(this.startDate.clone()),this.updateView())},formInputsBlurred:function(b){if(!this.endDate){var c=this.container.find('input[name="daterangepicker_end"]').val(),d=a(c,this.locale.format);d.isValid()&&(this.setEndDate(d),this.updateView())}},elementChanged:function(){if(this.element.is("input")&&this.element.val().length&&!(this.element.val().length<this.locale.format.length)){var b=this.element.val().split(this.locale.separator),c=null,d=null;2===b.length&&(c=a(b[0],this.locale.format),d=a(b[1],this.locale.format)),(this.singleDatePicker||null===c||null===d)&&(c=a(this.element.val(),this.locale.format),d=c),c.isValid()&&d.isValid()&&(this.setStartDate(c),this.setEndDate(d),this.updateView())}},keydown:function(a){9!==a.keyCode&&13!==a.keyCode||this.hide()},updateElement:function(){this.element.is("input")&&!this.singleDatePicker&&this.autoUpdateInput?(this.element.val(this.startDate.format(this.locale.format)+this.locale.separator+this.endDate.format(this.locale.format)),this.element.trigger("change")):this.element.is("input")&&this.autoUpdateInput&&(this.element.val(this.startDate.format(this.locale.format)),this.element.trigger("change"))},remove:function(){this.container.remove(),this.element.off(".daterangepicker"),this.element.removeData()}},b.fn.daterangepicker=function(a,d){return this.each(function(){var e=b(this);e.data("daterangepicker")&&e.data("daterangepicker").remove(),e.data("daterangepicker",new c(e,a,d))}),this},c}),function(a){"use strict";function b(a,b){var c=this;c.init(a,b)}var c=b.prototype;c.init=function(a,b){var c=this;c.elem=a,c.parentData=b,c.showingCustomRanges=!1,c.hideBtn=a.find(".ranges li").last(),c.showBtn=a.find(".calendar li").last(),c.bindEvents()},c.bindEvents=function(){var a=this,b=a.toggle.bind(a);a.showBtn.on("click.tcr",b),a.hideBtn.on("click.tcr",b)},c.toggle=function(){var a=this,b=a.showingCustomRanges?"removeClass":"addClass";a.elem[b]("custom-ranges"),a.showingCustomRanges=!a.showingCustomRanges,a.parentData.move()},a.fn.toggleCustomRange=function(c){return this.each(function(){var d=a(this),e=d.data("toggleCustomRange");e||d.data("toggleCustomRange",new b(d,c))}),this}}(jQuery),angular.module("rpDaterangepicker",[]),angular.module("rpDaterangepicker").run(["$templateCache",function(a){a.put("realpage/daterangepicker/templates/daterangepicker.html",'<div class="rp-daterangepicker form-group" ng-class="{icon: config.options.showIcon}"><div class="input-group"><input type="text" ng-model="rpModel" class="form-control" rp-daterangepicker-field> <span ng-if="config.options.showIcon" class="rp-daterangepicker-icon-wrap input-group-addon"><span class="rp-daterangepicker-icon fa fa-calendar"></span></span></div></div>')}]),function(a){"use strict";function b(b){var c="<div class='daterangepicker'><div class='calendar left'><div class='daterangepicker_input'><input class='input-mini form-control' type='text' name='daterangepicker_start' value='' /><i class='fa fa-calendar'></i></div><h6 class='daterangepicker_seperator'> to </h6><div class='daterangepicker_input'><input class='input-mini form-control' type='text' name='daterangepicker_end' value='' /><i class='fa fa-calendar'></i></div><div class='calendar-table'></div><ul class='text-center clearfix'><li>Hide Custom Range</li></ul><div class='ranges'><div class='range_inputs'></div></div></div></div>";return function(d){var e={showIcon:!0,singleDatePicker:!1,showDropdowns:!1,showWeekNumbers:!1,showISOWeekNumbers:!1,timePicker:!1,timePicker24Hour:!1,timePickerIncrement:1,timePickerSeconds:!1,autoApply:!1,dateLimit:!1,linkedCalendars:!1,autoUpdateInput:!0,showCustomRangeLabel:!0,alwaysShowCalendars:!1,parentEl:"body",startDate:b(),endDate:b().endOf("month"),minDate:!1,maxDate:!1,opens:"right",drops:"down",eventHandlers:[],applyClass:"btn-success",cancelClass:"btn-default",buttonClasses:"btn btn-sm",locale:{direction:"ltr",format:"MM/DD/YYYY",separator:" - ",applyLabel:"Apply",cancelLabel:"Cancel",weekLabel:"W",customRangeLabel:"Custom Range",daysOfWeek:b.weekdaysMin(),monthNames:b.monthsShort(),firstDay:b.localeData().firstDayOfWeek()},ranges:{Today:[b(),b()],Yesterday:[b().subtract(1,"days"),b().subtract(1,"days")],"Last 7 Days":[b().subtract(6,"days"),b()],"Last 30 Days":[b().subtract(29,"days"),b()],"This Month":[b().startOf("month"),b().endOf("month")],"Last Month":[b().subtract(1,"month").startOf("month"),b().subtract(1,"month").endOf("month")]},isShowing:!1,template:c},f={showIcon:!0,publishFormat:"x",onChange:a.noop};return d&&(Object.keys(e).forEach(function(a){void 0!==d[a]&&(e[a]=d[a],delete d[a])}),a.extend(f,d),f.options=e),f.setRange=function(a){return a&&(a.startDate&&(e.startDate=a.startDate),a.endDate&&(e.endDate=a.endDate)),f},f.destroy=function(){f=void 0,e=void 0},f}}a.module("rpDaterangepicker").factory("rpDaterangepickerConfig",["moment",b])}(angular),function(a,b){"use strict";function c(){function a(a,b,c){}return{scope:{config:"=",rpModel:"="},link:a,restrict:"E",replace:!0,templateUrl:"realpage/daterangepicker/templates/daterangepicker.html"}}b.module("rpDaterangepicker").directive("rpDaterangepicker",[c])}(jQuery,angular),function(a){"use strict";function b(b,c,d){function e(e,f,g,h){var i,j={},k=b(f),l=e.config,m=l.options;j.init=function(){h.$render=j.$render,h.$isEmpty=j.$isEmpty,h.$parsers.prepend(j.$parser),h.$formatters.push(j.$formatter),h.$validators.dateRange=j.$validator,l.setRange(e.rpModel),j.initWatch().bindEventHandlers().installValidators(),k.daterangepicker(l.options,j.onChange),j.picker=i=k.data("daterangepicker"),j.picker.container.toggleCustomRange(j.picker),e.daterangepickerField=j,e.$on("$destroy",j.destroy)},j.$render=function(){var a=h.$viewValue,b=a&&a.toLowerCase().match("invalid date"),c=h.$viewValue&&!b;k.val(c?h.$viewValue:"")},j.$validator=function(a,b){return b&&!b.toLowerCase().match("invalid date")},j.$isEmpty=function(b){return!(a.isString(b)&&b.length>0)},j.setValEmpty=function(){f.val("")},j.$parser=function(b){var c,d=m.locale.separator;if(c={startDate:null,endDate:null},a.isString(b)&&b.length>0)if(m.singleDatePicker)c=j.getMoment(b);else{var e=b.split(d).map(j.getMoment);c.startDate=e[0],c.endDate=e[1]}return c},j.$formatter=function(a){if(!a)return"";if(m.singleDatePicker&&a)return j.formatDate(a);if(a&&a.startDate){var b=m.locale.separator,c=j.formatDate(a.endDate),d=j.formatDate(a.startDate);return[d,c].join(b)}},j.initWatch=function(){return e.$watch("rpModel.endDate",j.setEndDate),e.$watch("rpModel.startDate",j.setStartDate),j},j.bindEventHandlers=function(){var a=m.eventHandlers,b=Object.keys(m.eventHandlers);return b.forEach(function(b){k.on(b,function(){e.$evalAsync(a[b])})}),k.on("cancel.daterangepicker",j.onCancel),j},j.installValidators=function(){m.minDate&&(h.$validators.minDate=j.$validateMin),m.maxDate&&(h.$validators.maxDate=j.$validateMax)},j.setStartDate=function(a){a&&i.endDate<a&&i.setEndDate(a),m.startDate=a,i.setStartDate(a)},j.setEndDate=function(a){a&&i.startDate>a&&i.setStartDate(a),m.endDate=a,i.setEndDate(a)},j.validateMin=function(a,b){return a.isBefore(b)||a.isSame(b,"day")},j.validateMax=function(a,b){return a.isAfter(b)||a.isSame(b,"day")},j.getMoment=function(a){return a?d(a,m.locale.format):a},j.formatDate=function(a){var b=m.locale.format;return d.isMoment(a)?a.format(b):d(a).format(b)},j.onChange=function(a,b){if(a.isValid()&&b.isValid())return e.$apply(function(){e.rpModel=m.singleDatePicker?a:{startDate:a,endDate:b};var d=e.rpModel,f=l.publishFormat;f&&(d={endDate:d.endDate.format(f),startDate:d.startDate.format(f)}),c(function(){l.onChange(d)})})},j.$validateMin=function(a){return a&&j.validateMin(m.minDate,a.startDate)},j.$validateMax=function(a){return a&&j.validateMax(m.maxDate,a.endDate)},j.onCancel=function(){m.clearable&&e.$apply(j.clearModel)},j.clear=function(){i.setEndDate(),i.setStartDate()},j.clearModel=function(){e.model=m.singleDatePicker?"":{endDate:"",startDate:""}},j.destroy=function(){j.picker.remove(),k.remove(),k=void 0,j=void 0,i=void 0},j.init()}return{link:e,restrict:"A",require:"ngModel"}}a.module("rpDaterangepicker").directive("rpDaterangepickerField",["jQuery","$timeout","moment",b])}(angular);