...
(function (angular) {
    ...
    function factory() {
        return function () {
            ...
            model.get = function (actionName) {
                return function () {
                    var method = model.src[actionName];

                    if (method && typeof method == "function") {
                        return method.apply(model.src, arguments);
                    }
                    else if (method === undefined) {
                        logc("actionsRepo.get: method " + actionName + " is undefined!");
                    }
                    else {
                        logc("actionsRepo.get: method " + actionName + " is not a function!");
                    }
                };
            };
...
(function (angular) {
    ...
    function factory($window) {
        ...
        svc.width = function () {
            ...
            svc._width = widthNoScroll - widthWithScroll;
    ...
    angular
        .module("app")
        .factory('scrollbar', ['$window', factory]);
})(angular);
    ...
    function Provider() {
        ...
        function provide($rootScope, location, eventStream) {
            ...
            model.getPageTitle = function (data) {
                var parts = [data.pageTitle, prodName, "OneSite"];
                return parts.join(" - ");
            };
...
(function (angular) {
    ...
    function factory(session, cookie, eventStream) {
        var model = {},
            ready = false;
    ...
    angular
        .module("rpSessionInfo")
        .factory("sessionInfo", ["sessionInfoSvc", "rpCookie", "eventStream", factory]);
})(angular);
