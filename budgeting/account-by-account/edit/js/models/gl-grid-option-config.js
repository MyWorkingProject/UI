(function (angular) {
    ...
    function factory(
        ...
        model.reset = function(){
            ...
            rowOptions = {
                title: glEditContent.gridRowOptionText,
                name: 'rowOptions',
                options: [{
                    key: 'show_reference_row',
                    isVisible: true,
                    title: glEditContent.gridShowReferenceRowText,
                    value: false
                    }, {
                    key: 'show_calculation_row',
                    title: glEditContent.gridShowCalculatedRowText,
                    isVisible: true,
                    value: false
                    }],
                itemType: 'checkbox',
            ...
            sizeOptions = {
                ...
                selected: '',
                options: [{
                        title: glEditContent.gridShowSmallSizeText,
                        value: '',
                        isVisible: true
                        },
                    {
                        title: glEditContent.gridShowLargeSizeTextText,
                        value: 'large',
                        isVisible: true
                    }],
                itemType: 'radio',
            ...
            gridColumns = {
                title: glEditContent.gridShowColumnOptionTextText,
                name: 'gridColumns',
                options: [],
                itemType: 'checkbox',
                hasDivider: false
    ...
    angular
        .module("budgeting")
        .factory("glGridOptionConfigModel", [
            '$filter',
            'glEditConstantModel',
            'glEditContentModel',
            'preferencesSVC',
